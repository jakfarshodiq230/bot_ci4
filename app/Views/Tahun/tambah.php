            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-12-tablet">
                    <div class="mdc-card">
                        <h6 class="card-title">Tambah Tahun</h6>
                    <form id="form_tahun" method="POST" role="form" action="<?= base_url('Tahun/add')?>">
                        <div class="mdc-layout-grid">
                        <div class="mdc-layout-grid__inner">
                            ...
                            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                ...
                                <input class="mdc-text-field__input" id="tahun" name="tahun"  required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
