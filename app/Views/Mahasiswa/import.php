            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-12-tablet">
                    <div class="mdc-card">
                        <h6 class="card-title">Import Mahasiswa</h6>
                    <form id="form_mahasiswa"  method="POST" action="<?= base_url('Mahasiswa/prosesExcel')?>" enctype="multipart/form-data">
                        <div class="mdc-layout-grid">
                        <div class="mdc-layout-grid__inner">
                        ...
                        <div class=" mt-4 mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                            <span>format Import Data Matakuliah Excel <a href="<?= base_url('Mahasiswa/DownlodFormat')?>" class="mt-6">Download</a></span>
                        </div>
                        </div>
                    </form>
                    </div>
