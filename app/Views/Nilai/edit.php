            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-12-tablet">
                    <div class="mdc-card">
                        <h6 class="card-title">Tambah Edit</h6>
                    <form id="form_semester" method="POST" role="form" action="<?= base_url('Nilai/update/'.$data['nilai']->id_nilai)?>">
                        <div class="mdc-layout-grid">
                        <div class="mdc-layout-grid__inner">
                            ...
                            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                ...
                                <input class="mdc-text-field__input" id="nim" name="nim" value="<?= $data['nilai']->nim ?>" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')" onKeyUp="CekNIM()" onkeypress="return hanyaAngka(event)">
                                    ...
                                    <select class="mdc-text-field__input"  name="matakuliah" id="matakuliah" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                                        ...
                                        <?php
                                            foreach ($data['matakuliah'] as $Matakuliah) {  
                                                if($data['nilai']->id_makul == $Matakuliah['id_makul']){      
                                        ?>   
                                                    <option value="<?=  $Matakuliah['id_makul']?>" selected><?= $Matakuliah['id_makul'].'-'. $Matakuliah['nama_makul']?></option>
                                         <?php
                                                }else{
                                         ?>
                            ...
                            <div id="id_tahun" class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                <div class="mdc-text-field mdc-text-field--outlined">
                                   <input class="mdc-text-field__input" id="kurikulum" name="kurikulum" value="<?= $data['nilai']->nama_ta ?>" readonly></input>
                                <div class="mdc-notched-outline">
                                    <div class="mdc-notched-outline__leading"></div>
                                    <div class="mdc-notched-outline__notch">
                            ...
                            <div id="id_semester"  class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                <div class="mdc-text-field mdc-text-field--outlined">
                                   <input class="mdc-text-field__input" id="semester" name="semester" value="<?= $data['nilai']->nama_sem ?>" readonly>
                                <div class="mdc-notched-outline">
                                    <div class="mdc-notched-outline__leading"></div>
                                    <div class="mdc-notched-outline__notch">
                            ...
                            <div id="id_nilai" class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                <div class="mdc-text-field mdc-text-field--outlined">
                                <input class="mdc-text-field__input" id="nilai" name="nilai" value="<?= $data['nilai']->nilai ?>" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                                <div class="mdc-notched-outline">
                                    <div class="mdc-notched-outline__leading"></div>
                                    <div class="mdc-notched-outline__notch">
                            ...
                            <div id="id_tanggalher" class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                <div class="mdc-text-field mdc-text-field--outlined">
                                <input type="date" class="mdc-text-field__input" id="tanggalher" name="tanggalher" value="<?= $data['nilai']->tanggal_her ?>"  required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                                <div class="mdc-notched-outline">
                                    <div class="mdc-notched-outline__leading"></div>
                                    <div class="mdc-notched-outline__notch">
