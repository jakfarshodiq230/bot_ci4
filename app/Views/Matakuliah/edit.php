            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-12-tablet">
                    <div class="mdc-card">
                        <h6 class="card-title">Edit Matakuliah</h6>
                    <form id="form_matakuliah" method="POST" role="form" action="<?= base_url('Matakuliah/update/'.$data['matakuliah']->id_makul)?>">
                        <div class="mdc-layout-grid">
                        <div class="mdc-layout-grid__inner">
                            ...
                            <?php endif; ?>
                             ...
                             <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                ...
                                <input class="mdc-text-field__input" id="matakuliah" name="matakuliah" value="<?= $data['matakuliah']->nama_makul ?>"  required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                            ...
                            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                <div class="mdc-text-field mdc-text-field--outlined">
                                <input class="mdc-text-field__input" id="standartnilai" name="standartnilai" value="<?= $data['matakuliah']->standart_nilai ?>"  required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                                <div class="mdc-notched-outline">
                                    <div class="mdc-notched-outline__leading"></div>
                                    <div class="mdc-notched-outline__notch">
                                    ...
                                    <select class="mdc-text-field__input"  name="semester" id="semester" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                                        ...
                                        <?php
                                            foreach ($data['semester'] as $semester) {
                                                if($data['matakuliah']->id_sem == $semester['id_sem']){
                                        ?>
                                                    <option value="<?= $semester['id_sem']?>" selected><?= $semester['nama_sem']?></option>
                                                    
                                        <?php
                                                }else{
                                        ?>
                                                    <option value="<?= $semester['id_sem']?>"><?= $semester['nama_sem']?></option>
                                        <?php
                                                }       
                                        ?>    
                                    ...
                                    <select class="mdc-text-field__input"  name="tahunajaran" id="tahunajaran" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                                        ...
                                        <?php
                                            foreach ($data['tahun'] as $tahun) { 
                                                if($data['matakuliah']->id_ta=$tahun["id_ta"] ){
                                        ?>
                                                    <option value="<?= $tahun['id_ta']?>" selected><?= $tahun['id_ta'].'-'.$tahun['nama_ta']?></option>
